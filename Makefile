...
a.out: csumpartialcopyuser.o copy_from_user.o copy_to_user.o clear_user.o strncpy_from_user.o memzero.o loadcontext.o main.o extable.o
...
strncpy_from_user.o: strncpy_from_user.S Makefile
	$(CC) $(OPTS) -o $@ $<
